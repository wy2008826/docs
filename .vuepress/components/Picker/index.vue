...
<script>
    ...
    import PickerColumn from 'components/Picker/PickerColumn';
    ...
    export default create({
        ...
        computed: {
            frameStyle() {
                return {
                    height: (this.itemHeight / (window.dpr ||1)) + 'rem'
                };
            },

            columnsStyle() {
                return {
                    height: (this.itemHeight / (window.dpr ||1)) * this.visibleItemCount + 'rem'
                };
            }
        },
