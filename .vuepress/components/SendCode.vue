<template>
    <div>
        <div :style="_style" class="phone_get" v-show="phone_state" v-text="phone_text" @click="get_phone">
            获取验证码
        </div>
        <div :style="_style" class="phone_wait" v-show="!phone_state">
            <span v-text="`${phone_time}s`"></span>
        </div>
    </div>
</template>
<script>
